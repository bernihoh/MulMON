...
data_path=/home/bernard/PycharmProjects/MulMON/mulmon_datasets/clevr
repo_path=.
...
--nodes 1 --gpus 1 --gpu_start 0 --master_port '29500' --use_bg  --kmeans_version 'after_lstm_only' \
## --resume_epoch 5
## init_only, init_before_lstm, init_after_lstm, before_lstm_only, after_lstm_only